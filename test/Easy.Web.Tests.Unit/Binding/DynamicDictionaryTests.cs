namespace Easy.Web.Tests.Unit.Binding
{
    using System.Collections.Generic;
    using Easy.Web.Core.Binding;
    ...
    internal sealed class DynamicDictionaryTests
    {
        ...
        public void When_testing_as_concrete_type()
        {
            ...
            dic.Values.ShouldBe(new [] { "A", "B", "C", "1" });
        ...
        public void When_testing_as_dynamic_type()
        {
            ...
            ((ICollection<string>)dic.Keys).ShouldBe(new[] { "A", "B", "C", "D" });
            ((ICollection<object>)dic.Values).ShouldBe(new object[] { "A", "B", "C", "1" });
        ...
        public void When_testing_case_sensitivity()
        {
            ...
            ((string)dynCaseSensetiveDic.Id).ShouldBe("66");
            ...
            ((string)dynCaseInSensetiveDic.Id).ShouldBe("66");
            ((string)dynCaseInSensetiveDic.ID).ShouldBe("66");
            ((string)dynCaseInSensetiveDic.id).ShouldBe("66");
        }
